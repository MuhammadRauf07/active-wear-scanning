...
class AllTrayScannerPage extends StatefulWidget {
  const AllTrayScannerPage({super.key});

  @override
  State<AllTrayScannerPage> createState() => _AllTrayScannerPageState();
}

class _AllTrayScannerPageState extends State<AllTrayScannerPage> {
  final MobileScannerController controller = MobileScannerController(detectionSpeed: DetectionSpeed.noDuplicates, returnImage: false);
